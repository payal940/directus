            ...
            function testDatabase() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        if (checks[`${client}:responseTime`][0].observedValue > 150 &&
                            checks[`${client}:responseTime`][0].status !== 'error') {
            ...
            function testRateLimiter() {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        ...
                        if (checks['rateLimiter:responseTime'][0].observedValue > 150 &&
                            checks['rateLimiter:responseTime'][0].status !== 'error') {
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    for (const location of to_array_1.toArray(env_1.default.STORAGE_LOCATIONS)) {
                        ...
                        try {
                            ...
                            if (checks[`storage:${location}:responseTime`][0].observedValue > 750 &&
                                checks[`storage:${location}:responseTime`][0].status !== 'error') {
