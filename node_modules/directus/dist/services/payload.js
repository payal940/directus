...
class PayloadService {
    constructor(collection, options) {
        ...
        this.transformers = {
            ...
            'file-links'({ action, value, payload }) {
                return __awaiter(this, void 0, void 0, function* () {
                    if (action === 'read' && payload && payload.storage && payload.filename_disk) {
                        ...
                        return {
                            asset_url: new url_1.URL(`/assets/${payload.id}`, env_1.default.PUBLIC_URL),
                            public_url: new url_1.URL(payload.filename_disk, env_1.default[publicKey]),
                        };
                    }
    ...
    processValues(action, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let specialFieldsInCollection = yield this.knex
                .select('field', 'special')
                .from('directus_fields')
                .where({ collection: this.collection })
                .whereNotNull('special');
            specialFieldsInCollection.push(...fields_1.systemFieldRows.filter((fieldMeta) => fieldMeta.collection === this.collection));
            if (action === 'read') {
            ...
            for (let i = 0; i < payloads.length; i++) {
                ...
                for (const relation of relationsToProcess) {
                    ...
                    if (payload[relation.one_field] && Array.isArray(payload[relation.one_field])) {
                        ...
                        savedPrimaryKeys = yield itemsService.upsert(relatedRecords);
                    }
