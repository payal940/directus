...
import { GraphQLSchema, GraphQLResolveInfo, ObjectFieldNode, SelectionNode, ArgumentNode } from 'graphql';
...
export declare class GraphQLService {
    ...
    getData(collection: string, selections: readonly SelectionNode[], argsArray: readonly ArgumentNode[], variableValues: GraphQLResolveInfo['variableValues']): Promise<Partial<Record<string, any>> | null>;
