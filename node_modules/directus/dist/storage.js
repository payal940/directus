...
const flydrive_s3_1 = require("@slynova/flydrive-s3");
const flydrive_gcs_1 = require("@slynova/flydrive-gcs");
validate_env_1.validateEnv(['STORAGE_LOCATIONS']);
const storage = new flydrive_1.StorageManager(getStorageConfig());
...
function getStorageDriver(driver) {
    switch (driver) {
        case 'local':
            return flydrive_1.LocalFileSystemStorage;
        case 's3':
            return flydrive_s3_1.AmazonWebServicesS3Storage;
        case 'gcs':
            return flydrive_gcs_1.GoogleCloudStorage;
    }
}
