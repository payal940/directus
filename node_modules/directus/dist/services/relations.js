    ...
    filterForbidden(relations) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.accountability === null || ((_a = this.accountability) === null || _a === void 0 ? void 0 : _a.admin) === true)
                return relations;
            const allowedCollections = yield this.permissionsService.getAllowedCollections(((_b = this.accountability) === null || _b === void 0 ? void 0 : _b.role) || null, 'read');
            const allowedFields = yield this.permissionsService.getAllowedFields(((_c = this.accountability) === null || _c === void 0 ? void 0 : _c.role) || null, 'read');
