    ...
    getAsset(id, transformation) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (['image/jpeg', 'image/png', 'image/webp'].includes(type)) {
                ...
                if (exists) {
                    return { stream: storage_1.default.disk(file.storage).getStream(assetFilename), file };
                }
                const readStream = storage_1.default.disk(file.storage).getStream(file.filename_disk);
                const transformer = sharp_1.default().resize(resizeOptions);
