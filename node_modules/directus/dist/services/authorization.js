...
class AuthorizationService {
    ...
    processAST(ast, action = 'read') {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let permissionsForCollections = yield this.knex
                .select('*')
                .from('directus_permissions')
                .where({ action, role: (_a = this.accountability) === null || _a === void 0 ? void 0 : _a.role })
                .whereIn('collection', collectionsRequested.map(({ collection }) => collection));
            permissionsForCollections = (yield this.payloadService.processValues('read', permissionsForCollections));
    ...
    validatePayload(action, collection, payload) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_a = this.accountability) === null || _a === void 0 ? void 0 : _a.admin) === true) {
                ...
                permission = yield this.knex
                    .select('*')
                    .from('directus_permissions')
                    .where({ action, collection, role: ((_c = this.accountability) === null || _c === void 0 ? void 0 : _c.role) || null })
                    .first();
                if (!permission)
                    throw new exceptions_1.ForbiddenException();
                permission = (yield this.payloadService.processValues('read', permission));
            ...
            for (const column of columns) {
                ...
                const specials = (field === null || field === void 0 ? void 0 : field.special) ? to_array_1.toArray(field.special) : [];
    ...
    validateJoi(validation, payloads) {
        ...
        if (Object.keys(validation)[0] === '_and') {
            ...
            const nestedErrors = lodash_1.flatten(subValidation.map((subObj) => this.validateJoi(subObj, payloads))).filter((err) => err);
